...
def get_args():
    ...
    parser.add_argument("ncode", type=str, help="N-code")
    parser.add_argument("--reset", "-r", action="store_true", help="delete and refetch all parts")
...
def main():
    ...
    try:
        req = request.Request(info_url, headers={"User-Agent": "Mozilla/5.0"})
        info_res = request.urlopen(req)
